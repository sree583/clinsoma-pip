...
def auto_qc(sample_id, coverage):
  print (f"Analysing NGS QC metrices for sample:{sample_id}")
...
output file = f"{sample_id}_qc_report.json"
...
if __name__ == "--main--":
  parser = argprase.argumentpraser(description= "clinicalNGS QC Automator Script")
  parser.add_name_or_flag = parser.add _ argument
